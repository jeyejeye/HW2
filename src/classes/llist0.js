...
LList0.prototype = Object.create(IList0.prototype);

LList0.prototype.constructor = LList0;

LList0.prototype.shift = function () {
    if (this.length === 0) {
        return undefined;
    }
...
LList0.prototype.unshift = function (value) {
...
LList0.prototype.push = function (value) {
    if (arguments.length === 0) {
        return this.length;
    }

    var e = new Entry(value, null, this.last);
...
LList0.prototype.splice = function () {
    let res = [];
    if (arguments.length === 0) {
        return res;
    }
...
LList0.prototype.isArray = function () {
    return Object.prototype.toString.call(this) === '[object Array]';
};

LList0.prototype.some = function (callback, thisArg) {
...
LList0.prototype.every = function (callback, thisArg) {
    const context = thisArg || this;
